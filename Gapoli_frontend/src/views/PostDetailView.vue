            ...
            <div class="p-2 bg-white border border-gray-200 rounded-lg">
                ...
                <div class='mx-4 my-2 ' v-for="(comment, index) in post.comment" v-bind:key="comment.id"
                    ...
                    <div class="mx-auto flex">
                        <div class="w-11/12 ">
                            <div class="p-4 bg-white border border-gray-200 rounded-br-lg rounded-l-lg" style="overflow: auto; word-wrap: break-word;">{{ comment.text }}
                            </div>
                        ...
                        <button v-if="userStore.user.id === comment.created_by.id" class="rounded-full ml-3 mt-3 w-5 h-5 items-center flex justify-center">
