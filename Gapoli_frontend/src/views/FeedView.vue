    ...
    <div class="max-w-7xl mx-auto grid grid-cols-4 gap-4">
        <div class="main-left col-span-1">
            <div class="p-4 bg-white border border-gray-200 text-center rounded-lg">
                <img src="https://img.favpng.com/8/7/15/hulk-superhero-icon-png-favpng-j7ZaifhXrReBKUiFaaMYQ22JJ.jpg" class="mb-6 rounded-full">
        ...
        <div class="main-center col-span-2 space-y-4">
            <div class="p-2 bg-white border border-gray-200 rounded-lg">
                <div class="p-4">
                    <textarea class="p-4 w-full bg-gray-100 rounded-lg" placeholder="What are you looking for today?"></textarea>
                </div>
            ...
            <div class="p-4 bg-white border border-gray-200 rounded-lg">
                <div class="mb-6 flex items-center justify-between">
                    ...
                    <div class="flex items-center space-x-6">
                        <img src="https://img.favpng.com/8/7/15/hulk-superhero-icon-png-favpng-j7ZaifhXrReBKUiFaaMYQ22JJ.jpg" class="w-[40px] rounded-full">
                        <p><strong>Hulk Smash</strong></p>
                    </div>
                ...
                <img src="https://img.favpng.com/8/7/15/hulk-superhero-icon-png-favpng-j7ZaifhXrReBKUiFaaMYQ22JJ.jpg" class="rounded-lg w-full">
            ...
            <div class="p-4 bg-white border border-gray-200 rounded-lg">
                ...
                <p>what a great day we defeat loki an his army i shoot thor and i smash every thing i am the incredible hulk</p>
        ...
        <div class="main-right col-span-1 space-y-4">
            ...
            <div class="p-4 bg-white border border-gray-200 rounded-lg">
                ...
                <div class="space-y-4">
                    <div class="flex items-center justify-between">
                        <p class="text-xs">
                            <strong>Avengers</strong><br>
                            <span class="text-gray-500">990 posts</span>
                        </p>

                        <a href="#" class="py-2 px-3 bg-purple-800 text-xs text-white rounded-lg">Explore</a>
                    </div>
