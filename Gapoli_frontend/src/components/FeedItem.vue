    ...
    <div class="my-6 flex justify-between">
        <div class="flex space-x-6">
            <div class="flex items-center space-x-2">
                ...
                <span class="text-gray-500 text-xs">{{ post.like_count }} {{ post.like_count <= 1 ? 'Like' : 'Likes'
                        }}</span>
            ...
            <div class="flex items-center space-x-2">
                ...
                <span class="text-gray-500 text-xs">{{ post.comment_count }} {{ post.comment_count <= 1 ? 'Comment'
                        : 'Comments' }}</span>
